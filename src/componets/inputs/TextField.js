...
export default function TextField(props) {
  ...
  return (
    <div style={props.backgroundStyle}>
        ...
        <input type={props.type} className={iconBackgroundColorInvert === "#000000" ? 'input-white' : 'input-black'} style={{...props.style, color: iconBackgroundColorInvert}} id={props.id} placeholder={props.placeholder} value={props.value} defaultValue={props.defaultValue} onChange={props.onChange} disabled={props.disabled} required/>
